...
/**
 * Intended for cases where a request for an entity that does not exist fails. Desipte the fact 
 * that an 400 response code is returned, additional information in the header may be used by the 
