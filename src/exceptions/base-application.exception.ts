 ...
 * application level errors are utilized throughout the code base, which in turn allows for the 
 * centralized handling of exceptions, at which point standardized responses are sent back to the 
 * client. 
 */
